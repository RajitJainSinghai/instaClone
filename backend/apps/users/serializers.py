...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('id', 'username', 'main_image', 'gender',
                  'email', 'password', 'token', 'token_expires','date_of_birth','contact_no')
...
class UserSignInSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'username', 'email', 'password', 'gender',
                  'main_image', 'token', 'token_expires', 'date_of_birth', 'contact_no')
